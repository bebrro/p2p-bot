...
# Длинный бэкофф: лимит обычно дневной/минутный, нет смысла долбить.
_COOLDOWN_UNTIL = 0.0
_COOLDOWN_SEC = 180
# Троттл: не чаще одного батч-запроса в N секунд. Экономим бесплатный лимит
# (~15/мин у 2.0-flash) и оставляем запас чату/прочему.
_LAST_CALL = 0.0
_MIN_INTERVAL = 12.0

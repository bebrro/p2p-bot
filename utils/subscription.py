...
PLANS: dict[str, dict] = {
    ...
    "pro": {
        ...
        "pnl":              True,
        "export":           True,
        "ai_daily":         50,     # честный безлимит (fair-use) — защищает lifetime
        "features": [
            "🤖 AI-ассистент — 50 вопросов в день",
    ...
    "team": {
        ...
        "pnl":              True,
        "export":           True,
        "ai_daily":         -1,     # безлимит (помесячно, recurring покрывает)
        "features": [
            "Всё из Pro +",
            "♾ Безлимитный AI-ассистент (без дневного лимита)",

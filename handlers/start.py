...
Логика:
• Новый пользователь (нет записи в DB) → автоматически 5 дней Pro + онбординг
...
MAIN_TEXT = (
    "🎯 <b>P2P Sniper</b>\n\n"
    "Сканер P2P-арбитража по 4 биржам.\n"
    "Курсы в реальном времени, связки без карт,\n"
    "антискам и авто-репрайсер.\n\n"
    "Выбери раздел:"
)

_WELCOME_NEW = (
    "🎯 <b>P2P Sniper — твой сканер P2P-арбитража</b>\n\n"
    "🎁 <b>Тебе открыт Pro на {days} дней — бесплатно, прямо сейчас.</b>\n"
    "Весь арсенал без ограничений:\n\n"
    "🤖 Авто-репрайсер — держит твои объявления в топе 24/7\n"
    "🔺 Связки без карт + 🔔 алерты прямо в ЛС\n"
    "🐋 Whale-трекер · 🧾 AI-проверка чеков на подделку\n"
    "🛡 Антискам: база 11 500 кидал Bybit\n"
    "♾ AI-ассистент по сделкам · 📈 P&L-аналитика\n\n"
    "Курс USDT на Binance · Bybit · OKX · TG Wallet — в одном окне, "
    "с защитой от приманок и фейк-цен.\n\n"
    "⏳ Через {days} дней Pro-фичи закроются — успей оценить и поднять профит.\n"
    "Жми «🚀 Открыть приложение» 👇"
)
